  ...
  const editor = useEditor({
    extensions: [
      StarterKit.configure({
        heading: { levels: [2, 3] },
        // disable extensions we don't expose in the toolbar
        blockquote:    false,
        codeBlock:     false,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {sep}
        {tool("Undo", false, !editor?.can().undo(), () => editor?.chain().focus().undo().run(), <Undo2 size={13} />)}
        {tool("Redo", false, !editor?.can().redo(), () => editor?.chain().focus().redo().run(), <Redo2 size={13} />)}
      </div>
