...
export const comparisons: Comparison[] = [
  // ─── Ergodotisi ──────────────────────────────────────────────
  {
    ...
    metaTitle: "CyprusTech.Jobs vs Ergodotisi — Best Tech Job Board in Cyprus 2026",
    metaDescription:
      "Comparing CyprusTech.Jobs and Ergodotisi for tech hiring in Cyprus. See which platform is better for software engineers, developers, and IT professionals.",
    verdict:
      "Ergodotisi is Cyprus's most established general job board and covers every industry. For tech roles specifically, CyprusTech.Jobs offers a more focused experience: every listing is technology-related, salaries are displayed upfront, and job seekers get AI-powered CV matching. If you work in software, engineering, or IT in Cyprus, you'll spend less time filtering noise on CyprusTech.Jobs.",
    features: [
    ...
    faq: [
      {
        question: "Is CyprusTech.Jobs better than Ergodotisi for software engineers?",
        answer:
          "For software engineers and IT professionals specifically, CyprusTech.Jobs is more focused. Every listing is technology-related, salaries are shown upfront, and you can filter by tech stack. Ergodotisi covers more sectors but requires more filtering to find relevant tech roles.",
      },
      {
        question: "Does Ergodotisi show salaries on job listings?",
        answer:
          "Ergodotisi leaves salary disclosure to the individual employer, so many listings do not include salary information. CyprusTech.Jobs requires employers to post a salary range with every listing.",
      },
      {
        question: "Can I search for remote tech jobs in Cyprus on Ergodotisi?",
        answer:
          "Ergodotisi has a general remote filter, but it applies across all sectors. CyprusTech.Jobs has dedicated remote, hybrid, and on-site filters specifically for tech roles in Cyprus.",
      },
      {
        question: "Is Ergodotisi free for job seekers?",
        answer:
          "Yes, creating a candidate account and applying for jobs on Ergodotisi is free. CyprusTech.Jobs is also free for candidates.",
      },
      {
        question: "Which platform has more tech job listings in Cyprus?",
        answer:
          "Ergodotisi has a larger overall volume of listings across all sectors. For tech-specific roles in Cyprus, CyprusTech.Jobs curates only technology positions, so the signal-to-noise ratio is higher for developers and engineers.",
      },
    ],
  ...
  // ─── CyprusWork ───────────────────────────────────────────────
  {
    ...
    metaTitle: "CyprusTech.Jobs vs CyprusWork — Tech Job Search in Cyprus 2026",
    metaDescription:
      "Side-by-side comparison of CyprusTech.Jobs and CyprusWork for technology professionals in Cyprus. Find out which job board is right for your tech career.",
    verdict:
      "CyprusWork is a capable general-purpose job board for the Cypriot market. For technology professionals, CyprusTech.Jobs is the more targeted option — with tech-only listings, mandatory salary transparency, and smart filtering by tech stack. CyprusWork is worth checking if you're open to roles across multiple industries.",
    features: [
      { feature: "Tech-only listings", cyprusTech: true, competitor: false },
      { feature: "Salary transparency", cyprusTech: true, competitor: false },
    ...
    faq: [
      {
        question: "How does CyprusTech.Jobs compare to CyprusWork for developers?",
        answer:
          "CyprusTech.Jobs is purpose-built for developers and tech professionals — every listing is tech-related, salaries are shown upfront, and you can filter by specific technologies. CyprusWork covers all industries, so developers need to filter more carefully.",
      },
      {
        question: "Does CyprusWork display salary information on job ads?",
        answer:
          "Salary disclosure on CyprusWork depends on each employer or agency. Many listings do not include salary information. On CyprusTech.Jobs, all listings must include a salary range.",
      },
      {
        question: "Are recruitment agency listings on CyprusTech.Jobs?",
        answer:
          "CyprusTech.Jobs currently focuses on direct employer postings for technology roles. CyprusWork includes both direct employer and recruitment agency listings.",
      },
      {
        question: "Which is easier to use for a tech job search in Cyprus?",
        answer:
          "Both platforms have clean English interfaces. CyprusTech.Jobs requires less filtering because only tech roles are listed, making the search experience faster for developers and engineers.",
      },
      {
        question: "Is CyprusWork free to use?",
        answer:
          "CyprusWork is free for job seekers. CyprusTech.Jobs is also free for candidates — creating a profile and applying for roles costs nothing.",
      },
    ],
    lastReviewed: "2026-04-01",
  },
  ...
  // ─── Carierista ────────────────────────────────────────────────
  {
    ...
    metaTitle: "CyprusTech.Jobs vs Carierista — Best Platform for Tech Jobs in Cyprus 2026",
    metaDescription:
      "Comparing CyprusTech.Jobs and Carierista for technology professionals in Cyprus. Salary transparency, tech stack filters, and AI CV tools side by side.",
    verdict:
      "Carierista is one of the most reputable career platforms in Cyprus, particularly strong in finance and professional services. For tech roles, CyprusTech.Jobs provides a more specialised experience: every listing is technology-focused, salaries are mandatory, and candidates get AI-powered CV matching. Tech professionals who also want career content and salary benchmarks may find value in using both.",
    features: [
      { feature: "Tech-only listings", cyprusTech: true, competitor: false },
      { feature: "Salary transparency", cyprusTech: true, competitor: false },
    ...
    faq: [
      {
        question: "Is CyprusTech.Jobs or Carierista better for software developers in Cyprus?",
        answer:
          "CyprusTech.Jobs is designed specifically for software developers and tech professionals. Carierista covers many more sectors and is particularly strong for finance and professional services. For a pure tech job search, CyprusTech.Jobs will surface more relevant listings without manual filtering.",
      },
      {
        question: "Does Carierista publish salary information on listings?",
        answer:
          "Salary disclosure on Carierista is at the employer's discretion, and many listings omit this information. CyprusTech.Jobs mandates salary ranges on all postings, so candidates always know what a role pays before applying.",
      },
      {
        question: "Does Carierista have a CV review tool?",
        answer:
          "Carierista does not currently offer an AI-powered CV review tool. CyprusTech.Jobs includes a built-in AI CV reviewer that scores your CV against a specific job description and provides actionable improvement suggestions.",
      },
      {
        question: "Can I find remote tech jobs on Carierista?",
        answer:
          "Carierista includes some remote listings but does not have a dedicated remote-work or hybrid filter for tech specifically. CyprusTech.Jobs has dedicated remote, hybrid, and on-site filters across all its tech listings.",
      },
      {
        question: "Is Carierista's salary survey useful for tech professionals?",
        answer:
          "Carierista's annual salary survey covers multiple sectors including technology, which makes it a useful benchmarking tool for tech professionals in Cyprus. CyprusTech.Jobs complements this with live salary data visible on active job listings.",
      },
    ],
    lastReviewed: "2026-04-01",
  },
  ...
  // ─── Kariera.com.cy ───────────────────────────────────────────
  {
    ...
    metaTitle: "CyprusTech.Jobs vs Kariera.com.cy — Tech Jobs in Cyprus Compared 2026",
    metaDescription:
      "CyprusTech.Jobs vs Kariera.com.cy for tech professionals in Cyprus. See how a dedicated tech job board compares to a general platform.",
    verdict:
      "Kariera.com.cy is a solid general-purpose career platform with cross-market coverage of Cyprus and Greece. For technology professionals working specifically in Cyprus, CyprusTech.Jobs offers a more focused search experience — every listing is a tech role, salary ranges are always shown, and smart filtering by tech stack makes discovery faster.",
    features: [
      { feature: "Tech-only listings", cyprusTech: true, competitor: false },
      { feature: "Salary transparency", cyprusTech: true, competitor: false },
      { feature: "Remote / hybrid filter", cyprusTech: true, competitor: "Basic" },
    ...
    aboutCyprusTech:
      "CyprusTech.Jobs is a Cyprus-native technology job board. By listing only tech roles and requiring full salary transparency, it aims to reduce friction for both candidates and employers in the island's growing tech sector. Candidates set up a profile once — tech stack, location preferences, salary expectations — and receive tailored alerts when matching roles appear.",
    aboutCompetitor:
    ...
    faq: [
      {
        question: "Which is better for finding tech jobs in Cyprus — CyprusTech.Jobs or Kariera.com.cy?",
        answer:
          "For tech-specific roles, CyprusTech.Jobs is more targeted. Every listing is a technology role, salaries are always shown, and you can filter by tech stack. Kariera.com.cy covers all industries across Cyprus and Greece, so tech candidates need to apply more filters.",
      },
      {
        question: "Does Kariera.com.cy show salaries on job listings?",
        answer:
          "Salary display on Kariera.com.cy is determined by the employer; many listings do not include a salary. CyprusTech.Jobs requires all employers to post a salary range, so candidates always see compensation before applying.",
      },
      {
        question: "Can I search for jobs across both Cyprus and Greece on CyprusTech.Jobs?",
        answer:
          "CyprusTech.Jobs focuses on technology roles in Cyprus. For jobs spanning Cyprus and Greece, Kariera.com.cy's cross-market presence may be more useful.",
      },
      {
        question: "Is there an AI-powered CV tool on Kariera.com.cy?",
        answer:
          "Kariera.com.cy does not currently offer an AI CV review feature. CyprusTech.Jobs includes an AI CV reviewer that evaluates your CV against a specific job listing and provides a match score with personalised recommendations.",
      },
      {
        question: "Are both platforms free for job seekers?",
        answer:
          "Yes, both CyprusTech.Jobs and Kariera.com.cy are free for candidates to register and apply for roles.",
      },
    ],
    lastReviewed: "2026-04-01",
  },
  ...
  // ─── CyprusJobs.com ───────────────────────────────────────────
  {
    ...
    metaTitle: "CyprusTech.Jobs vs CyprusJobs.com — Tech Job Boards in Cyprus 2026",
    metaDescription:
      "Comparing CyprusTech.Jobs and CyprusJobs.com for tech hiring in Cyprus. Discover which platform works best for software engineers and IT professionals.",
    verdict:
      "CyprusJobs.com is a veteran Cypriot job board with broad industry coverage and a simple posting experience. For technology professionals, CyprusTech.Jobs offers a more specialised alternative — all listings are tech roles, salaries are always disclosed, and an AI CV review tool helps candidates prepare stronger applications. CyprusJobs.com remains useful for non-tech roles or employers with cross-department hiring.",
    features: [
      { feature: "Tech-only listings", cyprusTech: true, competitor: false },
      { feature: "Salary transparency", cyprusTech: true, competitor: false },
      { feature: "Remote / hybrid filter", cyprusTech: true, competitor: false },
    ...
    faq: [
      {
        question: "How does CyprusTech.Jobs differ from CyprusJobs.com?",
        answer:
          "The main difference is focus: CyprusTech.Jobs lists only technology roles in Cyprus, while CyprusJobs.com covers all industries. CyprusTech.Jobs also mandates salary ranges on every listing and includes an AI CV review tool, which CyprusJobs.com does not offer.",
      },
      {
        question: "Does CyprusJobs.com show salaries on listings?",
        answer:
          "Salary information on CyprusJobs.com is optional for employers, so most listings do not include it. CyprusTech.Jobs requires all employers to display a salary range.",
      },
      {
        question: "Is CyprusJobs.com good for tech job seekers?",
        answer:
          "CyprusJobs.com does include tech listings, but they are mixed with roles from all other sectors. For a focused tech job search in Cyprus, CyprusTech.Jobs provides a better signal-to-noise ratio.",
      },
      {
        question: "Can employers search CVs on CyprusTech.Jobs?",
        answer:
          "CyprusTech.Jobs focuses on inbound job applications with candidate profiles and job alerts. CyprusJobs.com offers employers a CV database search to proactively reach candidates.",
      },
      {
        question: "Is CyprusJobs.com free for job seekers?",
        answer:
          "Yes, job seekers can browse and apply on CyprusJobs.com for free. CyprusTech.Jobs is also entirely free for candidates.",
      },
    ],
    lastReviewed: "2026-04-01",
  },
