...
export default async function JobsPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  /* Flat category lookup for label resolution */
  const allCatNodes = [
    ...categories.slice(1),
  ...
  /* URL builder — removes one filter param */
  function urlWith(key: string, val: string | undefined) {
    const p = new URLSearchParams();
    const cur: Record<string, string | undefined> = {
      search, category, type, employment, city, level, skill, salary: params.salary,
    };
    cur[key] = val;
    ...
    <div className="page-container" style={{ paddingBlock: "clamp(24px, 4vw, 40px)" }}>
      ...
      <div className="layout-sidebar-left" style={{ alignItems: "start" }}>
        ...
        <FilterBar
          ...
          current={{ category, type, employment, city, level, skill, salary: params.salary, search }}
          cities={CITIES}
        />
