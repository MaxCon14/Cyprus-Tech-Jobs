          ...
          <div style={{
            ...
            <div style={{ position: "relative", maxWidth: 560, margin: "0 auto" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "stretch", gap: 10, maxWidth: 360, margin: "0 auto" }}>
                ...
                <Link
        href="/jobs"
  style={{ justifyContent: "center", display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 8, color: "rgba(255,255,255,0.6)", fontSize: 13, fontFamily: "var(--font-sans)", textDecoration: "none" }}
>
